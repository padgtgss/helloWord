...
public class ProductController {
    ...
    @ResponseBody
    public Object getProuducts(Long terminalUserId,String productName, Integer productType, Long productCategoryId, Long cityId, Long districtId,
    ...
    private ProductPojo fetchPojoFromProduct(Product product) {
        ...
        /**获取商品图片信息*/
        List<ProductImage> productImageList = productImageService.getProductImageList(product.getId());
