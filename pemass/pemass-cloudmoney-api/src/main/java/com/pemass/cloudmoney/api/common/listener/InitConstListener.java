package com.pemass.cloudmoney.api.common.listener;
...
public class InitConstListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            prop.load(InitConstListener.class.getClassLoader().getResourceAsStream("pemass-cloudmoney-api.properties"));
